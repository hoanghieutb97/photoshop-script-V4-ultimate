...
for (var k = 0; k <= ban; k++) {
    ...
    if ((active_W - k_position - w_them_P) < 0) {
        ...
        { // luu file !!!!
            ...
            app.activeDocument.saveAs(Folder(folderBanInTool + "/in Truoc-b" + "-" + ten_Ban + "-" + nameSave + "-" + Math.ceil(actice_DOC.width.as("px") * 0.084667 / 10) + "x" + Math.ceil(actice_DOC.height.as("px") * 0.084667 / 10) + "cm" + ".tif"), TiffSaveOptionsLZW, false, Extension.LOWERCASE);
...
for (var k = 0; k <= ban; k++) {
    ...
    if ((active_W - k_position - w_them_P) < 0) {
        ...
        { // luu file !!!!
            ...
            if (!kenhSpot1) app.doAction("delete Spot 1", "tool");
            if (app.activeDocument.width < app.activeDocument.height) app.activeDocument.rotateCanvas(-90);
            app.activeDocument.saveAs(Folder(folderBanInTool + "/in Sau-b" + "-" + ten_Ban + "-" + nameSave + "-" + Math.ceil(actice_DOC.width.as("px") * 0.084667 / 10) + "x" + Math.ceil(actice_DOC.height.as("px") * 0.084667 / 10) + "cm" + ".tif"), TiffSaveOptionsLZW, false, Extension.LOWERCASE);
            app.activeDocument.close(SaveOptions.DONOTSAVECHANGES);
        }
