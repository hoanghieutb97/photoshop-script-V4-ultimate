...
if (arr[i].direction == "2")
    app.activeDocument.activeLayer.resize(cropA, cropB, AnchorPosition.MIDDLECENTER);
else if (arr[i].direction == "1") {
    if (WpH) app.activeDocument.activeLayer.resize(cropA, cropC, AnchorPosition.MIDDLECENTER);
    else app.activeDocument.activeLayer.resize(cropD, cropB, AnchorPosition.MIDDLECENTER);
}
