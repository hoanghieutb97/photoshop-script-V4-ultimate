...
{ ////////////////////////////////////////////////////////////// chay lop 5mm 2M
    ...
    for (var i = stt; i <= arr.length - 1; i++) {
        ...
        var soLayerCut = [[[1, 1, 6, 3], [1, 2, 6, 3], [1, 3, 6, 3]],
        [[6, 1, 6, 3], [6, 2, 6, 3], [6, 3, 6, 3]],
        ...
        for (var g = 0; g < soLayerCut.length; g++) {
            ...
            if (g == 2) app.activeDocument.resizeCanvas(360, app.activeDocument.height, AnchorPosition.MIDDLERIGHT);
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////ngan cach do
        #include "../split/nganCachDoNewWooden2M.jsx"; // căn giữa 1 file  Group_Khung và Group_In
...
{ ////////////////////////////////////////////////////////////// chay lop 3MM 1M
    ...
    for (var i = stt; i <= arr.length - 1; i++) {
        #include "convertPixel.jsx";
        var StatusCanGiua = false; // trạng thái sau khi duplicate có căn giữa với nhau không
        var soLayerCut = [[[2, 1, 6, 3], [2, 2, 6, 3]]];
...
{ ////////////////////////////////////////////////////////////// chay lop 3mm 2 M
    ...
    for (var i = stt; i <= arr.length - 1; i++) {
        #include "convertPixel.jsx";
        var StatusCanGiua = false; // trạng thái sau khi duplicate có căn giữa với nhau không
        var soLayerCut = [[[3, 1, 6, 3], [3, 2, 6, 3], [3, 3, 6, 3]],
        [[4, 1, 6, 3], [4, 2, 6, 3], [4, 3, 6, 3]],
        [[5, 1, 6, 3], [5, 2, 6, 3], [5, 3, 6, 3]]];
        var widthden = 0;
        var heightden = 0;
        var xoay = false;
        for (var g = 0; g < soLayerCut.length; g++) {
