...
{ ////////////////////////////////////////////////////////////// metal
    ...
    var typeTem = "metal 2M"; // khi createtem-group thì mới dùng
    var nameSave = "metal 2M"; // tên khi lưu
    ...
    for (var i = stt; i <= arr.length - 1; i++) {
        ...
        {// lấy file đen làm file gốc tính kích thước
            ...
            if (arr[i].nameId.split("-").shift() == "WAL") app.activeDocument.crop([0, 0, 2460, app.activeDocument.height]);
...
{ ////////////////////////////////////////////////////////////// go 3mm 2m
    ...
    for (var i = stt; i <= arr.length - 1; i++) {
        ...
        for (var g = 0; g < soLayerCut.length; g++) {
            ...
            var sttCropBox = soLayerCut[g][0];
            openFile(FileDesign, arr[i], type);
            if (arr[i].nameId.split("-").shift() == "WAL") app.activeDocument.crop([2460, 0, app.activeDocument.width, app.activeDocument.height]);
            #include "../split/Dung_Mot_Lan/NoOpen_cropBoxXY_black_resize_Dup_trans.jsx";
