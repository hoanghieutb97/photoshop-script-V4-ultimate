...
{ ////////////////////////////////////////////////////////////// chay lop go
    ...
    for (var i = stt; i <= arr.length - 1; i++) {
        ...
        var soLayerCut = [];
        var layerCutGoc = []
        if ((arr[i].nameId.split("-").shift() == "3L")) { soLayerCut = [[1, 1, 3, 1], [2, 1, 3, 1], [3, 1, 3, 1]]; layerCutGoc = [1, 1, 3, 1] }
        else if ((arr[i].nameId.split("-").shift() == "4L")) { soLayerCut = [[1, 1, 4, 1], [2, 1, 4, 1], [3, 1, 4, 1], [4, 1, 4, 1]]; layerCutGoc = [1, 1, 4, 1] }
        ...
        for (var g = 0; g < soLayerCut.length; g++) {
            ...
            if ((yPosition + boxH + hLast) > hAll && (xPosition + boxW + wLast) > wAll) {
                ...
                $.evalFile(File("//192.168.1.240/photoshop-script-V4-ultimate/label/createm-groupKT.jsx")); // in tem
