...
for (var i = stt; i <= arr.length - 1; i++) {
    ...
    if ((arr[i].nameId).substr(0, 2) == "1L") {
        ...
        soLayerCut = [[[1, 1, 4, 3], [1, 2, 4, 3], [1, 3, 4, 3]], [[2, 1, 4, 3], [2, 2, 4, 3], [2, 3, 4, 3]], [[3, 1, 4, 3], [3, 2, 4, 3], [3, 3, 4, 3]], [[4, 1, 4, 3], [4, 2, 4, 3], [4, 3, 4, 3]]];
        layerCutGoc = [1, 1, 4, 3]
    }
...
//     {
//         var typeFolderLuu = "in nguoc 2Mat-mica 3mm" // thư mục con trong banin-tool- chia ra để lưu theo loại
