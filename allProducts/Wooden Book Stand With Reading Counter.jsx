...
{ ////////////////////////////////////////////////////////////// chay lop 5mm 2M
    ...
    for (var i = stt; i <= arr.length - 1; i++) {
        ...
        var soLayerCut = [[[1, 1, 4, 3], [1, 2, 4, 3], [1, 3, 4, 3]],
        [[2, 1, 4, 3], [2, 2, 4, 3], [2, 3, 4, 3]],
        ...
        for (var g = 0; g < soLayerCut.length; g++) {
            ...
            if (g == 3) app.activeDocument.resizeCanvas(360, app.activeDocument.height, AnchorPosition.MIDDLERIGHT);
...
{ ////////////////////////////////////////////////////////////// chay lop 3mm 2 M
    ...
    for (var i = stt; i <= arr.length - 1; i++) {
        #include "convertPixel.jsx";
        var StatusCanGiua = false; // trạng thái sau khi duplicate có căn giữa với nhau không
        var soLayerCut = [[[4, 1, 4, 3], [4, 2, 4, 3], [4, 3, 4, 3]]];
        var widthden = 0;
        var heightden = 0;
        var xoay = false;
        for (var g = 0; g < soLayerCut.length; g++) {
