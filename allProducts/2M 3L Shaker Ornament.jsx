{ ////////////////////////////////////////////////////////////// 2m- mica 2mm
    ...
    var typeTem = "mica 2mm in xuoi 2M"; // khi createtem-group thì mới dùng
    var nameSave = "mica 2mm in xuoi 2M"; // tên khi lưu
    ...
    for (var i = stt; i <= arr.length - 1; i++) {
        ...
        var soLayerCut = [[[1, 1, 4, 3], [1, 2, 4, 3], [1, 3, 4, 3]], [[4, 1, 4, 3], [4, 2, 4, 3], [4, 3, 4, 3]], [[3, 1, 4, 3], [2, 2, 4, 3], [3, 2, 4, 3]]]
        var widthden = 0;
        var heightden = 0;
        var xoay = false;
