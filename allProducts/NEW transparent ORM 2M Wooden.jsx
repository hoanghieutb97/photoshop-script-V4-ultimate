...
var typeTem = "go 2M"; // khi createtem-group thì mới dùng
var nameSave = "go 2M"; // tên khi lưu
...
for (var i = stt; i <= arr.length - 1; i++) {
    ...
    {// lấy file đen làm file gốc tính kích thước
        ...
        cropBoxInXY(1, 1, 1, 3, app.activeDocument.width, app.activeDocument.height);
