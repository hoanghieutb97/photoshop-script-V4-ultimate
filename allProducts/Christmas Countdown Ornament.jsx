{ ////////////////////////////////////////////////////////////// go 3mm
    ...
    for (var i = stt; i <= arr.length - 1; i++) {
        ...
        if ((arr[i].nameId).substr(0, 2) == "3L") {
            if (arr[i].nameId.substr(arr[i].nameId.length - 2, 2) != "2M") soLayerCut = [[[1, 1, 4, 3], [1, 2, 4, 3]], [[4, 1, 4, 3], [4, 2, 4, 3]]];
            else soLayerCut = [[[4, 1, 4, 3], [4, 2, 4, 3]]];
        }
        else if (((arr[i].nameId).substr(0, 2) == "4L")) {
            if (arr[i].nameId.substr(arr[i].nameId.length - 2, 2) != "2M") soLayerCut = [[[1, 1, 5, 3], [1, 2, 5, 3]], [[4, 1, 5, 3], [4, 2, 5, 3]], [[5, 1, 5, 3], [5, 2, 5, 3]]];
            else soLayerCut = [[[4, 1, 5, 3], [4, 2, 5, 3]], [[5, 1, 5, 3], [5, 2, 5, 3]]];
        }
...
{ ////////////////////////////////////////////////////////////// go 2mm
    #include "createDocumentWooden2.jsx";
    var doc = app.activeDocument;
    var typeTem = "go 2mm"; // khi createtem-group thì mới dùng
    var nameSave = "go 2mm"; // tên khi lưu
    ...
    for (var i = stt; i <= arr.length - 1; i++) {
        ...
        var typeLop = "3L";
        if ((arr[i].nameId).substr(0, 2) == "3L")
            soLayerCut = [[[2, 1, 4, 3], [2, 2, 4, 3]]];

        else if (((arr[i].nameId).substr(0, 2) == "4L"))
            soLayerCut = [[[2, 1, 5, 3], [2, 2, 5, 3]]];
...
{ ////////////////////////////////////////////////////////////// mica 3mm
    #include "createDocumentWooden2.jsx";
    var doc = app.activeDocument;
    var typeTem = "mica 3mm only Cut"; // khi createtem-group thì mới dùng
    var nameSave = "mica 3mm only Cut"; // tên khi lưu
