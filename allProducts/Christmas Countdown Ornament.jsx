{ ////////////////////////////////////////////////////////////// chay lop mica
    ...
    for (var i = stt; i <= arr.length - 1; i++) {
        ...
        if ((arr[i].nameId).substr(0, 2) == "3L") {
            if (arr[i].nameId.substr(arr[i].nameId.length - 2, 2) != "2M") soLayerCut = [[[1, 1, 4, 3], [1, 2, 4, 3]], [[3, 1, 4, 3], [3, 2, 4, 3]], [[4, 1, 4, 3], [4, 2, 4, 3]]];
            else soLayerCut = [[[3, 1, 4, 3], [3, 2, 4, 3]], [[4, 1, 4, 3], [4, 2, 4, 3]]];
        }
        else if (((arr[i].nameId).substr(0, 2) == "4L")) {
            if (arr[i].nameId.substr(arr[i].nameId.length - 2, 2) != "2M") soLayerCut = [[[1, 1, 5, 3], [1, 2, 5, 3]], [[3, 1, 5, 3], [3, 2, 5, 3]], [[4, 1, 5, 3], [4, 2, 5, 3]], [[5, 1, 5, 3], [5, 2, 5, 3]]];
            else soLayerCut = [[[3, 1, 5, 3], [3, 2, 5, 3]], [[4, 1, 5, 3], [4, 2, 5, 3]], [[5, 1, 5, 3], [5, 2, 5, 3]]];
        }
