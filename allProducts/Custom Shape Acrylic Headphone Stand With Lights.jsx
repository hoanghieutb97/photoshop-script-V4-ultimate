...
{ ////////////////////////////////////////////////////////////// chay lop go 3mm
    ...
    for (var i = stt; i <= arr.length - 1; i++) {
        ...
        for (var g = 0; g < soLayerCut.length; g++) {
            ...
            if (g == 1) app.activeDocument.resizeCanvas(706, app.activeDocument.height, AnchorPosition.MIDDLERIGHT);
            else app.activeDocument.resizeCanvas(app.activeDocument.width - 706, app.activeDocument.height, AnchorPosition.MIDDLELEFT);
