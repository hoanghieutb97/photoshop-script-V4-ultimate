...
for (var i = stt; i <= arr.length - 1; i++) {
    ...
    {// tao khung su
        if (arr[i].nameId == "sac-KD-tron") { // tuy chinh product type
            app.open(File("//192.168.2.240/ps script data/khung bamboo wiless/tron.png"));
        }
        else if (arr[i].nameId == "sac-KD-hv") {
            app.open(File("//192.168.2.240/ps script data/khung bamboo wiless/vuong.png"));
        }
        else if (arr[i].nameId == "sac-KD-to-ong") {
            app.open(File("//192.168.2.240/ps script data/khung bamboo wiless/to ong.png"));
        }
        app.activeDocument.activeLayer.name = arr[i].stt;
