...
for (var i = stt; i <= arr.length - 1; i++) {
    ...
    {// tao khung su
        if (arr[i].nameId.split("-").pop() == "7,87")
            app.open(File("//192.168.1.194/ps script data/chan custom acrylic name night light pine.png"));
        else if (arr[i].nameId.split("-").pop() == "5,9")
            app.open(File("//192.168.1.194/ps script data/chan custom acrylic name night light pine nho.png"));
