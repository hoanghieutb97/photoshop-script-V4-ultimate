...
for (var i = stt; i <= arr.length - 1; i++) {
    ...
    #include "translateCMYK.jsx";
    {// tao khung su
        if (nho) app.open(File("//192.168.2.240/ps script data/chan custom acrylic name night light.png"));
        else app.open(File("//192.168.2.240/ps script data/chan custom acrylic name night light to.png"));
        app.activeDocument.activeLayer.name = arr[i].stt;
