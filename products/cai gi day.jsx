...
//         app.activeDocument.layers[1 + "a"].resize(wphone * 100 / widthdena, hphone * 100 / heightdena, AnchorPosition.MIDDLECENTER);
//         app.activeDocument.layers[1 + "b"].resize(wphone * 100 / widthdena, hphone * 100 / heightdena, AnchorPosition.MIDDLECENTER);
...
//     app.activeDocument.activeLayer = app.activeDocument.layers[1 + "a"];

//     app.activeDocument.layers[1 + "a"].name = arr[i].stt;
//     app.activeDocument.activeLayer.duplicate(app.documents["GLLM"].layerSets["CMYK"], ElementPlacement.PLACEATBEGINNING);
//     app.activeDocument.activeLayer = app.activeDocument.layers[1 + "b"];
//     app.activeDocument.layers[1 + "b"].name = arr[i].stt;
//     app.activeDocument.activeLayer.duplicate(app.documents["GLLM"].layerSets["SPOT"], ElementPlacement.PLACEATBEGINNING);
//     app.activeDocument.close(SaveOptions.DONOTSAVECHANGES);
//     app.activeDocument.activeLayer = app.activeDocument.layerSets["CMYK"].layers[0];
//     #include "translateCMYK.jsx";

//     app.activeDocument.activeLayer = app.activeDocument.layerSets["SPOT"].layers[0];
...
for (var i = stt; i <= arr.length - 1; i++) {
    ...
    #include "caculatorPosition.jsx";
    // app.activeDocument.activeLayer.resize(-100, undefined); //will flip layer horizontally
